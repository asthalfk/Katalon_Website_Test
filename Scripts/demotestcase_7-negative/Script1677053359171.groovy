...
// positive case using invalid username and valid password for login
WebUI.openBrowser('')
...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_Username_username'), 'John Doe LALA')
