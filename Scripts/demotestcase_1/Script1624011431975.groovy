...
// positive case using valid username and password for login
WebUI.openBrowser('')
...
WebUI.selectOptionByIndex(findTestObject('Page_CURA Healthcare Service/select_Tokyo CURA Healthcare Center'), 2)

WebUI.selectOptionByLabel(findTestObject('Page_CURA Healthcare Service/select_Tokyo CURA Healthcare Center'), 'Seoul CURA Healthcare Center', 
    false)
...
WebUI.check(findTestObject('Page_CURA Healthcare Service/input_None'))

WebUI.setText(findTestObject('Page_CURA Healthcare Service/textarea_Comment_comment'), 'testing kaltalon')
